...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BUfAmZSV.js
var router_BUfAmZSV_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-BB9c2DK3.css";
var APP_NAME = "Conoid";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "See residual astigmatism as a sine wave and watch Sturm’s conoid move as you flip a Jackson cross cylinder."
			},
			{
				name: "theme-color",
				content: "#0b0d10"
...
var $$splitComponentImporter = () => import("./routes-ejQdP1rK.mjs");
...
//#endregion
export { getRouter, router_BUfAmZSV_exports as t };
